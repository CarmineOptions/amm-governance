...
fn test_unstake_airdrop() {
    ...
    let team_member_2: ContractAddress = 0x0583a9d956d65628f806386ab5b12dccd74236a3c6b930ded9cf3c54efc722a1.try_into().unwrap(); 
    let random_user_1: ContractAddress = 0x052df7acdfd3174241fa6bd5e1b7192cd133f8fc30a2a6ed99b0ddbfb5b22dcd.try_into().unwrap(); 
    let random_user_2: ContractAddress = 0x21b2b25dd73bc60b0549683653081f8963562cbe5cba2d123ec0cbcbf0913e4.try_into().unwrap(); 
    let random_user_3: ContractAddress = 0x539577df56aab4269c13ece28baff916ef08c26ba480142a3ce1739d2e848d9.try_into().unwrap(); 
    ...
    assert(voting.balance_of(random_user_1) == 100000000000000000000000, 'wrong bal floating rndusr1');
