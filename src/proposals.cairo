...
pub(crate) mod proposals {
    ...
    pub(crate) fn assert_correct_contract_type(contract_type: ContractType) {
    ...
    fn hashing(
        ...
        if index >= calldata_span.len() {
            ...
            let hashed_data = LegacyHash::hash(a.into(), b);
            return hashing(hashed_data, calldata_span, index + 1_usize);
        }
    }

    #[generate_trait]
    pub(crate) impl InternalImpl<
